            ...
            <div className="w-full p-4 px-8 min-h-fit bg-[#221a3b] flex flex-col gap-6 text-white rounded-2xl pb-10">
                ...
                <div className="flex w-full h-full pb-4 px-32 items-center justify-center">
                 ...
                 <div className="items-center flex px-5">
                    <p className="text-white font-semibold text-4xl">{blinkTitle.length > 0 ? blinkTitle : "Blink Title"}</p>
                </div>
                <div className="items-center flex px-5">
                    <p className="text-[#bfbcbc] text-xl">{blinkDescription.length > 0 ? blinkDescription : "Blink description"}</p>
                </div>
                <div className="grid grid-cols-2 gap-2 w-full justify-center items-center px-5">
